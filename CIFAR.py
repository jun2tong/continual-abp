...
class CIFAR10(data.Dataset):
    ...
    def __init__(self, root, train=True,
        ...
        if num_instance_per_class==0:
            ...
            self.data, self.targets = self.RandomExamplers(self.data,self.targets,index,num_instance_per_class)
    ...
    def RandomExamplers(self, data,targets,index,num):
        data_tmp = []
        targets_tmp = []
        for i in index:
...
class ReassignedDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        """
        img, _ = self.ds[index]
        pseudo_target = self.pseudo_labels[index]
        # doing this so that it is consistent with all other datasets
        # to return a PIL Image
        
        return img, pseudo_target
    def __len__(self):
        return len(self.ds)

    def __repr__(self):
        fmt_str = self.ds.__repr__()
        return fmt_str